        ...
        <div class="row section-heading justify-content-center mb-5">
            <div class="col-md-8 text-center">
                ...
                <p class="sub-heading mb-5">
                    <?php echo esc_html($meal_section_description); ?>
                </p>
            </div>
        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            <input type="submit" id="reservenow" class="btn btn-primary btn-outline-primary btn-block"
                                   value="Reserve Now">
                            <a href="#" target="_blank" id="paynow" class="btn btn-primary btn-outline-primary btn-block">
                                <?php _e('Confirm Reservation', 'meal'); ?>
                            </a>
                        </div>
                    </div>
                </form>
