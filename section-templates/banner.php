...
$meal_section_meta = get_post_meta($meal_section_id, 'meal_secton_banner', true);
$meal_banner_image = get_template_directory_uri() . "/assets/images/slider-1.jpg)";
if (isset($meal_section_meta['banner_image'])) {
    $meal_banner_image = wp_get_attachment_image_src($meal_section_meta['banner_image'], 'large');
}
