        ...
        <div class="row">
            ...
            <div class="ftco-46">
                ...
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    <div class="ftco-46-image" style="background-image: url(<?php echo esc_url(get_the_post_thumbnail_url($meal_recipe_one->ID, 'large')); ?>);"></div>
                    <div class="ftco-46-text ftco-46-arrow-left">
                        ...
                        <h3 class="ftco-46-heading">
                            <?php echo esc_html($meal_recipe_one->post_title); ?>
                        </h3>
                        <p class="mb-5">
                    ...
                    <div class="ftco-46-image" style="background-image: url(<?php echo esc_url(get_the_post_thumbnail_url($meal_recipe_three->ID, 'large')); ?>"></div>
                </div>
                ...
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    <div class="ftco-46-text ftco-46-arrow-right">
                        ...
                        <h3 class="ftco-46-heading">
                            <?php echo esc_html($meal_recipe_two->post_title); ?>
                        </h3>
                        <p class="mb-5">
                    ...
                    <div class="ftco-46-image" style="background-image: url(<?php echo esc_url(get_the_post_thumbnail_url($meal_recipe_two->ID, 'large')); ?>);"></div>
                    <div class="ftco-46-text ftco-46-arrow-up">
                        ...
                        <p><a href="<?php echo get_the_permalink($meal_recipe_three); ?>"
                              class="btn-link"><?php _e('Learn More', 'meal'); ?><span class="ion-android-arrow-forward"></span></a>
                        </p>
                    </div>
                </div>
            </div>
