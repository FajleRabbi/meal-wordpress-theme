...
<?php
    ...
    $meal_section_meta = get_post_meta($meal_section_id, 'meal_secton_gallery', true);
            ...
            <div class="col-md-12">
                ...
                <div class="portfolio-grid portfolio-gallery grid-4 gutter">
                    ...
                    foreach($meal_gallery_items as $meal_gallery_item) :
                        ...
                        $meal_item_large = wp_get_attachment_image_src($meal_item_image_id, 'full');
                    ...
                    <div class="portfolio-item <?php echo esc_attr($meal_item_class); ?>">
                        <a href="<?php echo esc_url($meal_item_thumbnail[0]); ?>" class="portfolio-image popup-gallery" title="<?php echo esc_attr($meal_gallery_item['title']); ?>">
                            <img src="<?php echo esc_url($meal_item_large[0]); ?>" alt="<?php echo esc_attr($meal_gallery_item['title']); ?>"/>
                                    ...
                                    <div class="portfolio-category">
                                        <?php
                                            foreach ($meal_item_categories_array as $meal_item_category){
                                                printf('<span>%s</span>', $meal_item_category);
                                            }
                                        ?>
                                    </div>
                                </div>
