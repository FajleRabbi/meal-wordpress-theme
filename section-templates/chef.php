<?php
    ...
    $meal_section_meta = get_post_meta($meal_section_id, 'meal_section_chef', true);
                ...
                <div class="ftco-38">
                    <div class="ftco-38-img">
                        ...
                        <div class="ftco-38-body">
                            ...
                            <p>
                                <?php if($meal_chef['social_profile']['facebook']) : ?>
                                    <a href="<?php echo esc_url($meal_chef['social_profile']['facebook']); ?>" class="p-2"><span class="fa fa-facebook"></span></a>
                                <?php endif; ?>

                                <?php if($meal_chef['social_profile']['twitter']) : ?>
                                    <a href="<?php echo esc_url($meal_chef['social_profile']['twitter']); ?>" class="p-2"><span class="fa fa-twitter"></span></a>
                                <?php endif; ?>

                                <?php if($meal_chef['social_profile']['instagram']) : ?>
                                    <a href="<?php echo esc_url($meal_chef['social_profile']['twitter']); ?>" class="p-2"><span class="fa fa-instagram"></span></a>
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
